    ...
    <section class="page-title-section">
      <div class="container">
        <div class="breadcrumb-nav">
          ...
          <span>Estudios Científicos</span>
        </div>
        <h1 class="page-title">Estudios Científicos</h1>
      </div>
    </section>
...
<script setup>
const { data: articles } = await useAsyncData('estudios-cientificos', async () => {
  const data = await $fetch('/api/blog')
  return data.filter(a => a.category === 'estudios-cientificos')
})
...
useHead({
  title: 'Estudios Científicos | Bitácora | Magiancestral',
  meta: [
    { name: 'description', content: 'Investigaciones y estudios científicos sobre medicina ancestral y plantas sagradas' }
  ]
})
</script>
